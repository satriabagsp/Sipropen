...
$this->title = 'Proyeksi Penduduk Bulanan Kabupaten/kota (' . Yii::$app->user->identity->username . ')';
                    ...
                    <?php $form = ActiveForm::begin(); ?>
                        <span>
                            <?php if (!$cekPeriksa): ?>
                                ...
                                <?= $form->field($model, 'deskripsi')->hiddenInput(['maxlength' => true, 'value' => 'kosong'])->label(false) ?>
